      ...
      <div className="about-container1">
        ...
        <div className="card about--text1">
          <p className="about_text">
            ...
            besitzt einen Master in Finance & Accounting und einen Bachelor in
            ...
            ) . Als Referent für digitales Geld & digitale Assets konnte er beim
            Deutschen Sparkassen- und Giroverband (
            <a className="about_hyperlink" href="https://www.dsgv.de/">
              DSGV
            </a>
            ) seine Expertise in die Sparkassen-Finanzgruppe (SFG) einbringen.
            Zuvor war er Head of Corporates & Digital Markets bei der
            ...
            im Bereich Transaction Services (Financial Due Dilligence) sammeln,
            als auch als Senior-Consultant bei
            <a
              className="about_hyperlink"
            ...
            . Dort war er als Projektleiter bei MAN Truck & Bus und BMW tätig.
            Er besitzt eine hohe Affinität zu IT-Themen sowie analytisches
        ...
        <div className="card about--text2">
          <p className="about_text">
            ...
            Verantwortlichen der Deutschen Bundesbank vertreten. In der
            <a
              className="about_hyperlink"
            ...
            hat er bzgl. dem Kompensationsmodell und der User Client Journey die
            Interessen der
            <a
              className="about_hyperlink"
            ...
            und der
            <a className="about_hyperlink" href="https://www.wsbi-esbg.org/">
