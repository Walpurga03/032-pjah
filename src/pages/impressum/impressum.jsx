...
const Impressum = () => {
  ...
  return (
    <Fragment>
      ...
      <h3 className="subtitle">Verantwortlich</h3>
      <p className="text">
        Angaben gemäß § 5 TMG <br />
        Philipp Johannes Albert Hartmannsgruber
        <br /> PJAH Consulting <br />
        Felix-Fechenbach-Bogen 14 <br />
        80797 München
        <br />
        <br /> <strong>Kontakt</strong>
        <br /> Telefon: +49 170 808 2019
        <br /> E-Mail: consulting@pjah.de
        <br />
        <br />
        ...
        <br /> Die Europäische Kommission stellt eine Plattform zur
      ...
      <h3 className="subtitle">Datenschutz­erklärung</h3>
      <p className="text">
        <strong>1. Datenschutz auf einen Blick</strong>
        <br /> <br /> Allgemeine Hinweise <br /> <br />
        ...
        <strong>2. Hosting</strong> <br /> <br />
        IONOS Wir hosten unsere Website bei IONOS SE. Anbieter ist die IONOS SE,
        ...
        Ihrer IP-Adressen. Details entnehmen Sie der Datenschutzerklärung von
        IONOS: https://www.ionos.de/terms-gtc/terms-privacy. Die Verwendung von
        ...
        lit. a DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die
        ...
        unseren Weisungen und unter Einhaltung der DSGVO verarbeitet. <br />{" "}
        <br />
        <strong>
        ...
        Datenschutzerklärung. <br /> <br /> Wenn Sie diese Website benutzen,
        ...
        das geschieht. <br /> <br /> Wir weisen darauf hin, dass die
        ...
        dem Zugriff durch Dritte ist nicht möglich. <br /> <br />
        <strong>Hinweis zur verantwortlichen Stelle</strong>
        <br /> <br />
        Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website
        ist: <br /> <br />
        <strong>Philipp J.A. Hartmannsgruber</strong>
        <br /> <br />
        Felix-Fechenbach-Bogen 14 <br />
        80797 München <br /> <br />
        Telefon: +49 170 808 2019 <br />
        E-Mail: consulting@pjah.de <br /> <br /> Verantwortliche Stelle ist die
        ...
        nach Art. 9 Abs. 1 DSGVO verarbeitet werden. Sofern Sie in die
        ...
        <br /> <br /> Wir verwenden unter anderem Tools von Unternehmen mit Sitz
        in den USA oder sonstigen datenschutzrechtlich nicht sicheren
        Drittstaaten. Wenn diese Tools aktiv sind, können Ihre personenbezogene
        ...
        <br /> <br /> WENN DIE DATENVERARBEITUNG AUF GRUNDLAGE VON ART. 6 ABS. 1
        ...
        <br />
        <br /> WERDEN IHRE PERSONENBEZOGENEN DATEN VERARBEITET, UM DIREKTWERBUNG
        ...
        <br /> <br /> Sie haben das Recht, Daten, die wir auf Grundlage Ihrer
        ...
        und an dem Schloss-Symbol in Ihrer Browserzeile. <br /> <br />
        ...
        Daten können Sie sich jederzeit an uns wenden. <br /> <br />
        <strong>Recht auf Einschränkung der Verarbeitung</strong>
        <br /> <br /> Sie haben das Recht, die Einschränkung der Verarbeitung
        ...
        besteht in folgenden Fällen: <br /> <br /> Wenn Sie die Richtigkeit
        ...
        der Prüfung haben Sie das Recht, die Einschränkung der Verarbeitung
        Ihrer personenbezogenen Daten zu verlangen. Wenn die Verarbeitung Ihrer
        personenbezogenen Daten unrechtmäßig geschah/geschieht, können Sie statt
        der Löschung die Einschränkung der Datenverarbeitung verlangen. Wenn wir
        Ihre personenbezogenen Daten nicht mehr benötigen, Sie sie jedoch zur
        ...
        <br /> <br /> Der Nutzung von im Rahmen der Impressumspflicht
        ...
        Ihre Einwilligung weiter. <br /> <br /> Die Verarbeitung dieser Daten
        ...
        lit. a DSGVO) sofern diese abgefragt wurde. <br /> <br /> Die von Ihnen
        ...
        Einwilligung weiter. <br /> <br /> Die Verarbeitung dieser Daten erfolgt
        ...
        sofern diese abgefragt wurde. <br /> <br /> Die von Ihnen an uns per
        ...
        <br /> <br />
        <strong>Kommunikation via WhatsApp</strong>
        <br /> <br />
        ...
        Dublin 2, Irland. <br /> <br /> Die Kommunikation erfolgt über eine
        Ende-zu-Ende-Verschlüsselung (Peer-to-Peer), die verhindert, dass
        WhatsApp oder sonstige Dritte Zugriff auf die Kommunikationsinhalte
        erlangen können. WhatsApp erhält jedoch Zugriff auf Metadaten, die im
        Zuge des Kommunikationsvorgangs entstehen (z. B. Absender, Empfänger und
        ...
        unter: https://www.whatsapp.com/legal/#privacy-policy. Der Einsatz von
        WhatsApp erfolgt auf Grundlage unseres berechtigten Interesses an einer
        möglichst schnellen und effektiven Kommunikation mit Kunden,
        Interessenten und sonstigen Geschäfts- und Vertragspartnern (Art. 6 Abs.
        1 lit. f DSGVO). Sofern eine entsprechende Einwilligung abgefragt wurde,
        erfolgt die Datenverarbeitung ausschließlich auf Grundlage der
        Einwilligung; diese ist jederzeit mit Wirkung für die Zukunft
        widerrufbar. <br /> <br /> Die zwischen und auf WhatsApp ausgetauschten
        ...
        https://www.whatsapp.com/legal/business-data-transfer-addendum. Wir
        haben unsere WhatsApp-Accounts so eingestellt, dass es keinen
        automatischen Datenabgleich mit dem Adressbuch auf den im Einsatz
        befindlichen Smartphones macht. <br /> <br /> Wir haben einen Vertrag
        über Auftragsverarbeitung (AVV) mit dem oben genannten Anbieter
        geschlossen. <br /> <br />
        <strong>5. Analyse-Tools und Werbung</strong>
        <br /> <br />
        IONOS
        <br /> <br /> WebAnalytics Diese Website nutzt die Analysedienste von
        IONOS WebAnalytics (im Folgenden: IONOS). Anbieter ist die 1&1 IONOS SE,
        Elgendorfer Straße 57, D – 56410 Montabaur. Im Rahmen der Analysen mit
        IONOS können u. a. Besucherzahlen und –verhalten (z. B. Anzahl der
        ...
        IONOS insbesondere folgende Daten: <br /> <br />
        <strong>Referrer (zuvor besuchte Webseite)</strong>
        <br /> <br />
        ...
        <br /> Die Datenerfassung erfolgt laut IONOS vollständig anonymisiert,
        ...
        an der statistischen Analyse des Nutzerverhaltens, um sowohl sein
        ...
        <br />
        <br /> Weitere Informationen zur Datenerfassung und Verarbeitung durch
        ...
        <br />
        <br /> Wir haben einen Vertrag über Auftragsverarbeitung (AVV) mit dem
